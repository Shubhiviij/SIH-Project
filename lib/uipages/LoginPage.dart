              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 20),
                    ToggleButtons(
                      isSelected: [_selectedType == UserType.Citizen, _selectedType == UserType.Admin],
                      onPressed: (index) {
                        setState(() {
                      ...
                      children: [
                        Padding(
                          ...
                          child: Row(children: [Icon(Icons.person), Text(' Citizen')]),
                        ),
                        Padding(
                          padding: const EdgeInsets.symmetric(horizontal: 26, vertical: 8),
                          child: Row(children: [Icon(Icons.admin_panel_settings), Text(' Admin')]),
                        ),
                      ],
                    ),
                    SizedBox(height: 22),
                      ...
                      onPressed: () {
                        if (_formKey.currentState!.validate()) {
                          ...
                          if (_selectedType == UserType.Admin) {
                            // Check admin credentials (security enforced here)
                            // Navigate to AdminDashboard if valid admin
